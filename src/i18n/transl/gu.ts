...
export default {
  ...
  navigation: {
    ...
    bottomTabs: {
      RootMainTabStack: '{{firstName}}નું coldboxstore',
  ...
  Auth: {
    ...
    SignUp: {
      ...
      welcome: 'coldboxstoreમાં આપનું સ્વાગત છે',
      schema: {
        passwordError:
  ...
  Dashboard: {
    ...
    Management: {
      ...
      AddRegisteredEmployee: {
        message: 'coldboxstore એપ્લિકેશનમાં નોંધાયેલ કર્મચારી તરીકે જોડાવવા માટે, અહીં જાઓ: {{link}}',
        toasts: {
  ...
  tutorial: {
    ...
    farmerWelcome:
      'coldboxstore માં તમારું સ્વાગત છે! આ ટ્યુટોરીયલ તમને એપ કેવી રીતે વાપરવી એ સમજવામાં મદદ કરશે.',
    ...
    steps: {
      ...
      marketplaceStep1:
        'આ coldboxstore ડિજિટલ માર્કેટપ્લેસ છે, જ્યાં બધા વપરાશકર્તાઓ ઠંડા રૂમમાં સંગ્રહિત ઉત્પન્ન ખરીદી અને વેચી શકે છે. વેચાણ માટે દરેક ક્રેટ અહીં સૂચિબદ્ધ છે, અને તમે કોઈપણ માત્રા (કિલોગ્રામમાં) કે આખું ક્રેટ ખરીદી શકો છો.',
      marketplaceStep2:
