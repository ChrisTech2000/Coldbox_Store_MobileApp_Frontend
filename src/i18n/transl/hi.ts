...
export default {
  ...
  Dashboard: {
    ...
    Analytics: {
      ...
      farmersAnalytics: {
        coolingUserName: 'कूलिंग उपयोगकर्ता का नाम',
        coolingUserType: 'कूलिंग उपयोगकर्ता का प्रकार',
        ...
        noChangeFoodLoss: 'खाद्य हानि में कोई परिवर्तन नहीं',
        foodLossEvolution: '🥗 फसल के प्रति खाद्य हानि विकास (शीर्ष 5)',
        changePercentage: '% परिवर्तन',
        crops: 'फसलें',
        foodLossLevels: 'खाद्य हानि के स्तर',
        revenueEvolution: '💰 औसत राजस्व विकास',
        revenueCropEvolution: '💰 फसल के प्रति औसत राजस्व विकास (शीर्ष 5)',
        noChangeRevenue: 'राजस्व में कोई परिवर्तन नहीं',
        revenueLevels: 'राजस्व के स्तर',
        baselineSurveyLabel: '📊 पूर्ण बेसलाइन सर्वेक्षणों की संख्या',
        postCheckoutSurveyLabel: '📊 पूर्ण पोस्ट-चेकआउट सर्वेक्षणों की संख्या',
      },
      companyTab: {
        usersTab: {
