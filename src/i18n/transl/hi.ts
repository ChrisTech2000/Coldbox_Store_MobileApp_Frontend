...
export default {
  ...
  navigation: {
    ...
    bottomTabs: {
      RootMainTabStack: '{{firstName}} का Coldboxstore',
  ...
  Auth: {
    welcomePopup:
      "Coldboxstore में आपका स्वागत है! यदि आप किसान, व्यापारी हैं, या कोल्ड रूम में संग्रहीत उत्पाद खरीदने में रुचि रखते हैं, तो कृपया 'शीतलन उपयोगकर्ता या उपभोक्ता के रूप में साइन अप करें' पर क्लिक करके साइन अप करें। यदि आप किसी शीतलन कंपनी में काम करते हैं, तो कृपया अपने उत्तरदायी व्यक्ति से संपर्क करें और जांचें कि आपकी कंपनी पंजीकृत है या नहीं। यदि हां, तो आपका उत्तरदायी व्यक्ति आपको एक एसएमएस आमंत्रण भेजेगा ताकि आप पंजीकृत कर्मचारी या ऑपरेटर के रूप में साइन अप कर सकें। यदि नहीं, तो आप कंपनी को पंजीकृत कर सकते हैं और पंजीकृत कर्मचारी के रूप में साइन अप कर सकते हैं। कृपया 'ऐप जानकारी' अनुभाग में अक्सर पूछे जाने वाले प्रश्नों की जाँच करें।",
    Root: {
      welcome: 'स्वागतम',
      signIn: 'साइन इन करें',
    ...
    SignUp: {
      ...
      welcome: 'Coldboxstore में आपका स्वागत है',
      schema: {
        passwordError:
    ...
    Invite: {
      heading: 'Coldboxstore में आपका स्वागत है',
      employee:
  ...
  Dashboard: {
    ...
    noLocationsAvailable:
      'Coldboxstore में आपका स्वागत है। प्रबंधन पैनल में अपने ऐप में स्थान जोड़कर शुरुआत करें।',
    ...
    Management: {
      ...
      Operators: {
        banner:
          'आपको एक परिचालक के रूप में Coldboxstore ऐप में शामिल होने के लिए आमंत्रित किया गया था। पंजीकरण पूरा करने के लिए, यहां जाएं:',
        text: {
          gender: 'लिंग',
          ma: 'पुरुष',
          fe: 'महिला',
      ...
      AddOperator: {
        messages: {
          operator: 'एक ऑपरेटर के रूप में Coldboxstore ऐप में शामिल होने के लिए, यहां जाएं: {{link}}',
        },
        toasts: {
  ...
  tutorial: {
    ...
    farmerWelcome:
      'Coldboxstore में आपका स्वागत है! यह ट्यूटोरियल आपको ऐप का उपयोग समझने में मदद करेगा।',
    ...
    steps: {
      ...
      marketplaceStep1:
        'यह Coldboxstore का डिजिटल मार्केटप्लेस है, जहाँ सभी उपयोगकर्ता कोल्ड रूम में संग्रहीत उत्पादों को खरीद और बेच सकते हैं। बिक्री के लिए प्रत्येक क्रेट यहाँ सूचीबद्ध है, और आप कोई भी मात्रा (किलोग्राम में) या पूरा क्रेट खरीद सकते हैं।',
      marketplaceStep2:
