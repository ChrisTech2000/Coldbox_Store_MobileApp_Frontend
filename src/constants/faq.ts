...
export const FAQ_CONTENT: Record<TranslationLocales, Faq[]> = {
  ...
  [APP_LOCALES.PORTUGUESE]: [
    {
      id: 1,
      title: 'Você deve usar o aplicativo?',
      role: [ERoles.AUTH],
      text: ' aplicativo é projetado para acompanhar os fornecedores de quartos froides em suas operações cotidianas, os agricultores que os utilizam e os consumidores que desejam comprar produtos armazenados em quartos froides. Ela propõe um inventário numérico, um acompanhamento à distância e um modelo de duração de conservação para cada caixa armazenada, assim como um local de mercado onde se relacionam compradores e vendedores. Elle inclui também um centro de conhecimento, que fornece recomendações específicas para cada produto sobre a temperatura e o tempo de conservação ideal.',
    },
    {
      id: 2,
      title: 'Você pode usar o aplicativo?',
      role: [ERoles.AUTH],
      text: 'aplicativo é destinado a empresas de armazenamento refrigerado, agricultores e comerciantes interessados na utilização de quartos froides, também como acheteurs potenciais do mundo inteiro. Três funções de usuário são definidas no aplicativo: (i) Empregado registrado: membro da equipe de direção do fornecedor de quartos froides. A pessoa responsável pela instalação e gerenciamento da câmara é encarregada de supervisionar as atividades dos operadores no terreno, sem estar fisicamente presente no local. Por exemplo: PDG, diretor financeiro, etc. (ii) Operador: empregado físico presente na câmara fria e responsável pelas operações de registro e de partida. Esta pessoa está em contato direto com os usuários da câmara fria e conta com um funcionário registrado na empresa. (iii) Utilisateurs ou consommateurs de la chambre froide: utilisateurs de la chambre froide (agricultores, negociantes, détaillants, etc.) ou consommateurs (particulares, détaillants, grossistes). Este papel é endereçado a todas as pessoas que desejam inscrever-se no aplicativo sans être liée para uma empresa de refroidissement. Os usuários da sala fria disponíveis em um smartphone podem se conectar ao aplicativo tanto quanto os usuários. Se não for o caso, os operadores efetuam operações de refrigeração para eux.',
    },
    {
      id: 3,
      title: 'Como posso me inscrever quando você está registrado?',
      role: [ERoles.AUTH],
      text: 'Se você for o primeiro funcionário de sua empresa para se inscrever, clique no botão «S"inscrere en tant qu"entreprise» e siga as etapas para você inscrever e registrar (informações pessoais e senha incluídas). Uma vez inscrito, você pode se conectar ao funcionário inscrito no aplicativo e enviar um convite por SMS para outros funcionários inscritos para alegrar sua empresa. Uma vez que a empresa foi criada, todos os funcionários inscritos serão convidados por SMS. Sinon, eles não serão conectados à mesma empresa.',
    },
    {
      id: 4,
      title: "Comment puis-je m'inscrere en tant qu'opérateur ?",
      role: [ERoles.AUTH],
    ...
    {
      id: 5,
      title: 'Como posso me inscrever no usuário ou consumidor de refroidissement ?',
      role: [ERoles.AUTH],
      text: 'Os usuários de equipamentos de climatização de smartphones e consumidores podem inscrever-se em um clique em «Inscreva-se como usuário ou consumidor» na página inicial e indique suas informações pessoais e sua senha. Os usuários que não possuem smartphones podem ser adicionados ao aplicativo pelos operadores. Esta operação é necessária para iniciar o registro desses usuários. Os usuários devem fornecer um número de telefone que o operador utiliza para contatá-los em caso de necessidade. Nenhuma mot de passe não é necessária neste caso.',
    },
    {
      id: 6,
      title: "Je n'arrive pas à finaliser mon inscription. O que dois-je faire?",
      role: [ERoles.AUTH],
      text: 'Para encerrar a inscrição, certifique-se de que as seguintes condições serão respondidas: (i) Vous informar um número de telefone com o país indicado (por exemplo, +91 para a Índia); (ii) O número de telefone que você forneceu e não foi utilizado para registrar outro usuário; (iii) A senha que você deve responder a todas as condições exigidas; (iv) As senhas que você disse são as mesmas - você pode clicar no símbolo do cartão para revelar as senhas e verificar quais são.',
    },
    {
      id: 7,
      title: 'Eu não tenho telefone, mas quero usar o aplicativo. O que dois-je faire?',
      role: [ERoles.AUTH],
      text: 'Se você é um empregado, um operador ou um consumador registrado, você deve fornecer um número de telefone válido para sua inscrição. Um smartphone é necessário para usar o aplicativo corretamente. Se você usar um sistema de climatização e não tiver telefone, aconselhamos também fornecer um número de telefone válido para que o operador possa contatá-lo em caso de necessidade. Você também pode indicar o número do telefone de um próximo ou de um amigo se você não tiver nenhum. Se isso não for possível, o operador poderá armazenar todos os produtos na sala, selecionando «Utilizador sem telefone» como usuário da climatização durante o registro.',
    },
    {
      id: 8,
      title: 'Quais detalhes são necessários para se conectar enquanto você está registrado?',
      role: [ERoles.AUTH],
      text: 'Funcionários registados podem fazer login com e-mail ou número de telefone e a sua senha.',
    },
    {
      id: 9,
      title: 'Quais detalhes são necessários para se conectar ao operador?',
      role: [ERoles.AUTH],
    ...
    },
    {
      id: 10,
      title:
        'Quais detalhes são necessários para se conectar ao usuário ou consumidor de refrigeração?',
      role: [ERoles.AUTH],
      text: 'Os usuários do dispositivo de resfriamento de um smartphone podem se conectar com seu número de telefone e sua senha. Os usuários sem smartphone não precisam se conect[APP_LOCALES.ARABIC]: o operador efetua as operações em seu local. Os consumidores que desejam acessar o local de mercado podem se conectar com seu número de telefone e sua senha.',
    },
    {
      id: 11,
      title: 'Eu não recebi nenhum convite por SMS. O que dois-je faire?',
      role: [ERoles.AUTH],
    ...
    {
      id: 12,
      title: 'Eu perdi minha senha. O que fazer?',
      role: [ERoles.AUTH],
      text: 'Se você perder sua senha, você pode restaurar sua conta ao clicar em «Senha desativada» durante a conexão, entre em seu número de telefone e receba um SMS com uma garantia para definir uma nova senha.',
    },
    {
      id: 13,
      title: 'O que é o Knowledge Hub?',
      role: [ERoles.EMPLOYEE],
      text: 'Le Centre de connaissances é uma página acessível clicando no menu em alta qualidade. Ele contém informações úteis sobre as melhores práticas de armazenamento para diferentes produtos, incluindo a temperatura ideal e o tempo de armazenamento aproximado a esta temperatura.',
    },
    {
      id: 14,
      title: 'Comente puis-je modificador mon perfil?',
      role: [ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Ao clicar em « Menu » -> « Detalhes da conta », você pode consultar seu perfil e modificar suas « Informações pessoais » (nome, nome, número de telefone, endereço de e-mail e sexo). Em “Preferências de localização”, você pode modificar o idioma do aplicativo. Sob « Parâmetros do vendedor », você pode configurar suas coordenadas bancárias, criar cupons e fornecer suas coordenadas públicas para os usuários do mercado. Para alterar as informações relativas à sua empresa, aos seus locais e às suas unidades de refrigeração, acesse « Menu » -> « Gerenciamento » e selecione o elemento do menu desejado.',
    },
    {
      id: 15,
      title: 'Comente puis-je modificador mon perfil?',
    ...
    {
      id: 16,
      title: 'Como você pode afetar os operadores nas unidades de refrigeração?',
      role: [ERoles.OPERATOR],
    ...
    },
    {
      id: 17,
      title:
        'Um usuário de climatização chega à sala fria, mas não ao telefone. Então, quando você me registrar?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Sim, você pode fazer um registro para esta pessoa usando o usuário de climatização «Utilizador sem telefone». É importante que os plusieurs personnes possam utilizar esta conta para registro, garantindo que você adicione uma etiqueta nominativa nas caixas da peça para identificar o proprietário de cada caixa.',
    },
    {
      id: 18,
      title: 'Como enregistrer mon entreprise ?',
      role: [ERoles.EMPLOYEE],
    ...
    {
      id: 19,
      title: 'Como registrar uma nova localização para minha empresa ?',
      role: [ERoles.EMPLOYEE],
    ...
    {
      id: 20,
      title: 'Como registrar uma nova unidade de refroidissement para minha empresa ?',
      role: [ERoles.EMPLOYEE],
    ...
    },
    {
      id: 21,
      title:
        'Como convidar outros funcionários inscritos na minha empresa para se inscrever no aplicativo?',
      role: [ERoles.EMPLOYEE],
      text: 'Para convidar outros Funcionários Registados para a sua empresa, no menu selecione "Gestão" > "Funcionários". Clique no "+" no canto superior direito para adicionar o número de telefone do funcionário que você deseja convidar. Clique em "Convidar" para confirm[APP_LOCALES.ARABIC]: o seu colega receberá um SMS com um link que o direciona diretamente para a tela de registo. Além disso, você também receberá um e-mail com o link de convite. Por favor, encaminhe isso ao operador caso ele não tenha recebido via SMS.',
    },
    {
      id: 22,
      title: 'Como convidar os operadores de empresa para registrar o aplicativo?',
      role: [ERoles.EMPLOYEE],
      text: 'Para enviar um convite para operadores das suas unidades de refrigeração, no menu selecione "Gestão" > "Operadores". Clique no "+" no canto superior direito para adicionar o número de telefone do operador que você deseja convidar. Clique em "Convidar" para confirm[APP_LOCALES.ARABIC]: o operador receberá uma mensagem com um link que o direciona diretamente para a tela de registo. Além disso, você também receberá um e-mail com o link de convite. Por favor, encaminhe isso ao operador caso ele não tenha recebido via SMS.',
    },
    {
      id: 23,
      title: 'Como monitorar a temperatura de um grupo de refrigeração?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para monitorar a temperatura de um climatizador específico, clique em « Plus » na parte inferior direita da barra de navegação, selecione « Unidades de climatização », depois « Condições ambientais » e selecione o climatizador em questão no menu suspenso. Este painel exibe um gráfico que mostra a evolução da temperatura no arquivo de temperatura. Clique em um ponto de presente para ver seu valor e seu valor. Se a peça estiver equipada com sensores conectados ao aplicativo, você pode verificar e consultar a temperatura real. Sinon, o gráfico mostra as temperaturas reguladas manualmente pelo operador da peça no aplicativo. Para consultar a temperatura de outro climatizador, selecione-o no menu exibido no topo da página.',
    },
    {
      id: 24,
      title: 'Como vigiar a ocupação de uma unidade de refrigeração?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para gerenciar a ocupação de uma unidade de refrigeração específica, clique em « Plus » na parte inferior direita da barra de navegação, selecione « Unidades de refrigeração », acesse « Planificador » e selecione a unidade de refrigeração desejada no menu selecionado. Você e encontrará a ocupação atual (em alta) e a ocupação anterior durante os 7 próximos dias (em baixo). As informações sobre a futura ocupação são baseadas no número de dias de armazenamento declarado por cada usuário durante o registro. Veuillez observe que não há dúvida de que uma estimativa e que ela pode ser inexata.',
    },
    {
      id: 25,
      title: 'Como posso ver quais objetos são armazenados em uma peça?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
    ...
    {
      id: 26,
      title: 'Como posso ver os registros e as saídas de uma unidade de refroidissement?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para consultar o histórico de movimentos de uma unidade de refrigeração, clique em « Plus » na parte inferior direita da barra de navegação e selecione « Histórico ». Os registros (ícones com uma caixa verde), as partidas (ícones com uma caixa laranja) e as operações na praça de mercado (ícones com um panier bleu) com os detalhes das transações são exibidas. Se houver uma transação específica de seu interesse, a função de pesquisa poderá ajudá-lo a recuperá-la!',
    },
    {
      id: 28,
      title: 'Quais são as principais maneiras pelas quais o operador pode atuar no aplicativo?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'operador pode registrar novos usuários de climatização, efetuar controles de entrada, monitorar os artigos armazenados e a ocupação dos locais, efetuar controles de saída e monitorar a temperatura da unidade de climatização sem carregar. Ele também pode ajudar os usuários a vender caixas e fixar um preço de venda.',
    },
    {
      id: 29,
      title: 'Como posso registrar novos usuários de refroidissement ?',
      role: [ERoles.OPERATOR],
      text: 'Para registrar um novo usuário de climatização, acesse o menu «Gestão» > «Utilizadores de climatização». Clique em « + » à direita e escolha adicionar um usuário que já foi registrado com um código ou adicionar suas informações. Um usuário de climatização possui um smartphone e já está inscrito no Coldtivate, dispõe de um código único e acessível em « Menu » -> « Detalhes da conta » -> « Informações pessoais » -> « Código de importação do usuário de climatização ». Se o usuário não for um smartphone ou não estiver mais inscrito, você poderá adicioná-lo indiquantmente seu nome, sexo e número de telefone. Se o usuário não tiver um número pessoal, você poderá usar o número de outra pessoa (amigos, família, etc.). Observe que um número de telefone não pode ser utilizado apenas uma vez. Clique em “Registrar modificações” para confirmar. Para finalizar a inscrição, você deve responder a um questionário judicial com algumas perguntas ao usuário de climatização. A consulta pode também ser concluída posteriormente com base em «Gestion» -> «Utilizadores de refroidissement» -> «Enquete auprès des utilisateurs de refroidissement».',
    },
    {
      id: 30,
      title:
        'usuário do sistema de refrigeração não responde às perguntas da sonda durante a inscrição. O que dois-je faire?',
      role: [ERoles.OPERATOR],
    ...
    },
    {
      id: 31,
      title:
        'Um operador me exige um código para adicionar à lista de usuários de climatização da empresa. Você pode encontrar esse código?',
      role: [ERoles.OPERATOR],
    ...
    },
    {
      id: 32,
      title:
        'Não tenho tempo para responder às perguntas da sondagem durante a inscrição. O que dois-je faire?',
      role: [ERoles.OPERATOR],
    ...
    {
      id: 33,
      title: 'Je souhaite stocker mes récoltes en chambre froide. Comentar puis-je les trouver ?',
      role: [ERoles.EMPLOYEE],
      text: 'Para encontrar quartos frios perto de você, acesse « Plus » na parte inferior direita da barra de navegação, selecione « Unidades de refrigeração » e « Cartão ». Vous pourrez alors rechercher des chambres froides à proximité, puis y déposer vos caisses. A exploração da câmara fria pode explicar-lhe o funcionamento, as modalidades de fabricação e as vantagens do ambiente refrigerado.',
    },
    {
      id: 34,
      title: 'Como posso iniciar um registro?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Para fazer um registro, acesse o quadro de borda e clique no botão Gerenciador de atividades à direita e depois clique no botão verde.',
    },
    {
      id: 35,
      title: 'Comentar puis-je lancer un pagamento ?',
      role: [ERoles.OPERATOR],
      text: 'Existem duas formas de lançar uma surtida, todas as duas a partir do quadro de bordo. Clique no botão «Gestionário de atividades» baixo à direita e depois no botão vermelho. Você também pode selecionar o utilitário (e a unidade de refrigeração) para iniciar a saída e retirar as caixas de entradas adicionais. Você também pode clicar em « Ver os detalhes » para um artigo exibido no quadro de bordo (certifique-se de que você encontrou na boa unidade de refroidissement) e depois clicar em « Retirer ». Nesse caso, você não pode retirar as caixas deste artigo.',
    },
    {
      id: 36,
      title:
        'Eu tenho sensores de temperatura na câmara fria. Você pode estar conectado ao Coldtivate?',
      role: [ERoles.AUTH],
    ...
    {
      id: 37,
      title: 'Como conectar os sensores da peça com o aplicativo?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Se os sensores de temperatura nesta peça puderem estar conectados ao aplicativo Coldtivate, entre em contato com seu responsável. Os usuários que possuem a função de registro registrado podem associar captadores a unidades de refrigeração criadas no Coldtivate.',
    },
    {
      id: 38,
      title: 'Como posso regular a temperatura da unidade de refrigeração?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para regular a temperatura da unidade de refrigeração, siga o procedimento definido pela sua empresa. A aplicação permite vigiar, mais lentamente, a temperatura da câmara fria. No entanto, se o aplicativo não for confiável para os sensores, é importante manter a temperatura definida no aplicativo no momento. Para isso, clique em « Sair la température » no painel « Plus » -> « Unités de refroidissement » > « Conditions ambiantes ». O ajuste diário da temperatura permitirá visualizar a evolução da temperatura no aplicativo e obter previsões precisas sobre o tempo de conservação restante das mercadorias armazenadas. Se o aplicativo for dependente dos captadores, a possibilidade de modificar a temperatura será desativada, e o aplicativo extrai regularmente essas informações diretamente dos captadores.',
    },
    {
      id: 39,
      title:
        'Como entrar em contato com um usuário de refroidissement para o estudo de marcha após o estoque?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Na guia « Plus » -> « Histórico », você pode consultar a lista dos últimos retratos. Entre em contato com cada usuário de quarto frio para efetuar um retorno para resolver a consulta pós-estocagem. Para acessar, clique nos três pontos no canto inferior direito e selecione “Remplir l"enquête de marché”. Ao clicar em “Ver detalhes”, você pode verificar a mercadoria armazenada e o número de telefone do usuário através do contato por telefone. Sinon, você pode visitar a próxima visita do usuário na sala fria para armazenar outros itens. Um ponto vermelho identifica os retratos da história para as sequências da pesquisa de mercado no encore foi realizado. Um rappel você será enviado no painel de notificação para os retratos necessários à sua atenção. Clique na notificação para abrir a consulta.',
    },
    {
      id: 40,
      title: 'que é que o estudo de marcha após a estocagem e para que dois possam ser reparados?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Estudo de Marcha é acessível clicando nos três pontos da região de cada passagem na caixa na faixa «Plus» -> «Histórico» e depois selecionando «Remplir o Estudo de Marcha». Muito gentil, esta pergunta exige informações sobre o preço de venda dos produtos que você já havia estocado anteriormente na câmara fria, e também sobre sua variedade. Essas informações foram tratadas de forma confidencial e utilizadas exclusivamente pela equipe Coldtivate para avaliar o impacto do uso do estoque frio. Um ponto vermelho identificou as passagens em caixa para as sequências do estudo de marcha no encore foi realizado. Um rapel será enviado no painel de notificação para as passagens que exigem sua atenção. Clique na notificação para abrir a consulta. Você também pode acessar perguntas para responder na guia «Análises» e depois clicar em «Impacto».',
    },
    {
      id: 41,
      title: 'Como ler informações de um elemento no quadro de bordo?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Cada elemento do quadro de bordo exibe um conjunto de caixas do mesmo tipo de cultura, conjunto registrado. O nome dos dias indicado em cima indica o nome dos dias restantes no momento do retorno. Então, você encontrará o tipo de cultura e o identificador de registro. O nome no canto do símbolo da caixa indica o nome das caixas registradas. À beira-mar, você encontrará os valores de refroidissement e o número de dias de armazenamento das caixas. Le nombre à côté de la carte à droite indica o nome de caisses en vente sur la place de marché. Em cada artigo, você encontrará o nome do proprietário e suas coordenadas.',
    },
    {
      id: 42,
      title: 'Qual é o horário de recuperação?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'atraso de retirada corresponde ao número de dias sugerido para que o usuário possa recuperar um produto. Passado este tempo, o produto começa a perder o valor da marcha. Um atraso na retirada é nulo, indicando que o usuário deve recuperar o artigo imediatamente e dispor de dois dias no máximo para a venda no mercado. Este atraso pode ser consultado no quadro de bordo e na vista detalhada de cada artigo armazenado.',
    },
    {
      id: 43,
      title: 'Como é que o atraso do prêmio é calculado? Quais fatores influenciam?',
      role: [ERoles.OPERATOR],
      text: 'As frutas e os legumes frescos são perigosos e a perda de calor após a colheita depende em grande parte da temperatura. O atraso da massagem é calculado em função da temperatura da unidade de refrigeração correspondente e da qualidade inicial do produto quando chega à unidade. Os parâmetros utilizados neste cálculo são adequados para cada produto. Você encontrará informações sobre as diferenças de aptidão entre os diferentes produtos no Centro de Conhecimento.',
    },
    {
      id: 44,
      title: 'O atraso da massagem é de 0 dia, mas os produtos são sempre em bom estado. Porquê?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'atraso no retorno é o valor prédito. Então, um usuário de climatizadores pode ser válido para encontrar e vender um artigo armazenado com um atraso de retirada de 0 dia. No entanto, sachez qu"une suree perte de qualité est invisível à l"œil nu ; Ele é aconselhado a seguir em frente sobre possíveis indicações de atraso no retorno. A previsão do atraso de retorno é particularmente precisa se o aplicativo estiver associado a sensores de temperatura. Se você não tiver isso, vamos dar-lhe conselhos de instalação em seus climatizadores. Consulte as perguntas sobre os sensores de temperatura para obter mais informações sobre a configuração.',
    },
    {
      id: 45,
      title: 'O atraso da massagem é de mais de 0 dia, mas os produtos são quase perdidos. Porquê?',
      role: [ERoles.OPERATOR],
      text: 'atraso no retorno é um valor preditivo. Pode acontecer, em casos raros, que os produtos fiquem abîmés quando o atraso de retorno é superior a 0. A degradação da qualidade dos produtos depende de uma grande quantidade de temperatura, os valores de temperatura permitem obter uma previsão mais precisa. Por exemplo, o problema pode ocorrer quando algum sensor de temperatura não está conectado ao aplicativo e o operador pode ajustar uma temperatura incorreta na peça. Se você não tiver sensores de temperatura, siga as instruções de instalação em suas unidades de refrigeração. Consulte as perguntas sobre os sensores de temperatura para obter mais informações sobre a configuração.',
    },
    {
      id: 46,
      title: 'O atraso da massagem é de mais de 0 dia, mas os produtos são quase perdidos. Porquê?',
      role: [ERoles.OPERATOR],
      text: 'atraso no retorno é um valor preditivo. Pode acontecer que, em casos raros, os produtos fiquem abîmés quando o atraso de retorno é superior a 0. A degradação da qualidade dos produtos depende muito da temperatura, os valores de temperatura permitem obter previsões mais precisas. Por exemplo, esse problema pode surgir quando algum sensor de temperatura não estiver conectado ao aplicativo e o operador não ajustar regularmente a temperatura da peça no aplicativo. Informe o operador da peça se ela for produzida.',
    },
    {
      id: 47,
      title:
        "Le taux d'occupation des chambres pour l'un des prochains jours est rouge (menos de 20%). Sur quoi est-ce base? Dois-je m'inquiéter ?",
      role: [ERoles.OPERATOR, ERoles.EMPLOYEE],
      text: 'taxa de ocupação é exibida em vermelho quando mais de 80% da capacidade da unidade de refrigeração é utilizada. As informações sobre as taxas de ocupação futuras são baseadas no nome dos dias de armazenamento anteriores por cada usuário durante o registro. Atenção, não se sabe que uma estimativa e células podem ser inexatas. Por conseguinte, a taxa de ocupação vermelha de um quarto indica simplesmente que o quarto está bientôt pleine. Se você não se perguntar, você poderá agir em conseqüência. Por exemplo, você pode entrar em contato com os usuários de climatização, pois o estoque está mais rapidamente disponível para o consultor de forma rápida. Você pode consultar a lista de artigos mais urgentes para retirar no «Quadro de bordo» quando você classificar por hora de retirada.',
    },
    {
      id: 48,
      title:
        'O usuário do sistema de climatização traz para a peça um produto que não aparece na lista. Então, quando você me registrar?',
      role: [ERoles.OPERATOR, ERoles.EMPLOYEE],
      text: 'Claro, neste caso, você pode fazer uma verificação selecionando “Outre” na lista de produtos. Em «Informações complementares», você também pode informar o nome do produto, o que o ajudará a encontrá-lo.',
    },
    {
      id: 49,
      title:
        'No quadro de borda, cada elemento é representado por uma barra colorida. O que representa esta cor?',
      role: [ERoles.EMPLOYEE],
      text: 'A cor representa o nome dos dias restantes antes do enlèvement. A barra é vermelha se o atraso for inferior em 2 dias, amarelo se o atraso for inferior em 7 dias e verde se o atraso for superior em 7 dias. Esses valores são específicos para cada artigo estocado e são recalculados mais diariamente em função da temperatura na unidade de refrigeração. Embora nenhum modelo de cálculo esteja disponível, a barra é cinza.',
    },
    {
      id: 50,
      title:
        'Eu terminei um registro, mas não vou mais repetir os elementos no quadro de bordo. Porquê?',
      role: [ERoles.OPERATOR],
      text: 'mise à jour du tableau de bord pode demorar um certo tempo. Certifique-se também de que utiliza um bom sistema de refrigeração. Se o problema persistir, envie o sinal para app@yourvcca.org.',
    },
    {
      id: 51,
      title: 'Eu terminei um comando, mas eu sempre vou ler os artigos no quadro de bordo. Porquê?',
      role: [ERoles.OPERATOR],
      text: 'A mise à jour du tableau de bord pode demorar um certo tempo. Verifique também se os elementos que você verificou estão bons e procure um bom aparelho de refrigeração. Se o problema persistir, envie o sinal para app@yourvcca.org.',
    },
    {
      id: 52,
      title: 'Como posso verificar se o sensor de temperatura está funcionando corretamente?',
      role: [ERoles.OPERATOR],
      text: 'Quando um empregado foi registrado e ativou a conexão de um sensor a um climatizador, o botão de saída manual de temperatura no painel « Plus » -> « Climatiseurs » > « Condições ambientais » está cinza. Os dados do captador serão recuperados durante as 6 horas. Se o captor funcionar corretamente, você deve verificar o rastreamento de temperatura com novos pontos positivos ao longo do dia. Se um captador não for enviado por dados após 12 horas, uma notificação será enviada aos operadores da sala e aos funcionários registrados.',
    },
    {
      id: 53,
      title: 'Eu recebi uma notificação indicando que o captor não funciona. O que dois-je faire?',
      role: [ERoles.OPERATOR],
    ...
    {
      id: 54,
      title: 'Como calcular o tempo do prêmio gratuitamente, mas não há capturas?',
      role: [ERoles.EMPLOYEE],
    ...
    {
      id: 55,
      title: 'Cada vez que um registro é iniciado, um alerta de temperatura é emitido. Porquê?',
      role: [ERoles.OPERATOR],
    ...
    },
    {
      id: 56,
      title:
        'À medida que um pagamento é finalizado, você recebe um alerta de temperatura. Porquê?',
      role: [ERoles.EMPLOYEE],
    ...
    },
    {
      id: 57,
      title:
        'Por que você precisa de um usuário de climatização para responder a um questionário antes de poder registrar a primeira caixa?',
      role: [ERoles.OPERATOR],
    ...
    {
      id: 58,
      title: 'Por que você precisa preencher um questionário ao inscrevê-lo no aplicativo?',
      role: [ERoles.EMPLOYEE],
    ...
    },
    {
      id: 60,
      title:
        'Por que você precisa exigir dos usuários de sistemas de refrigeração o preço de venda de cada elemento de estoque?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Você será convidado a entrar em contato com um usuário do sistema de climatização antes de retirar recentemente os produtos da peça e do seu cliente e a esse preço na venda dos produtos armazenados. Essas informações auxiliam a equipe de desenvolvimento do aplicativo para validar e melhorar a precisão das previsões de preço do mês de março.',
    },
    {
      id: 61,
      title: 'Eu não compreendi certas partes do aplicativo. Quem é o contator ?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Não ouça consultar o tutorial e as perguntas frequentes, pois eles contêm informações úteis no aplicativo que pode responder às suas perguntas. Para entrar em contato com a equipe de assistência do aplicativo, envie um e-mail para app@yourvcca.org.',
    },
    {
      id: 62,
      title: 'Eu não compreendi certas partes do aplicativo. Quem é o contator ?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Não deixe de consultar o tutorial e as perguntas frequentes, pois eles contêm informações úteis no aplicativo que podem ajudá-lo a responder às suas perguntas. Se sua pergunta permanecer sem resposta, entre em contato com o funcionário com a inscrição Dont Vous dépendez.',
    },
    {
      id: 66,
      title: 'Eu não compreendi certas partes do aplicativo. Quem é o contator ?',
    ...
    {
      id: 67,
      title: 'Eu encontrei um bug no aplicativo. Quem é o contator ?',
      role: [ERoles.COOLING_USER],
      text: 'Certifique-se de que você dispõe da última versão do aplicativo. Se o problema persistir, entre em contato com a equipe de assistência do aplicativo por e-mail para app@yourvcca.org ou responda ao formulário de comentários: https://forms.gle/ceohKHT2QCcE3rFs5.',
    },
    {
      id: 68,
      title:
        "Quelque escolheu ne fonctionne pas correctement dans l'application. Quem é o contator ?",
      role: [ERoles.OPERATOR],
      text: 'Certifique-se de que a última versão do aplicativo esteja instalada. Se o problema persistir, entre em contato com o funcionário registrado, não dependa e/ou informe a equipe de assistência do aplicativo, enviando um e-mail para app@yourvcca.org ou respondendo ao formulário de comentários: https://forms.gle/2gKVzZjkJSPqEAan9.',
    },
    {
      id: 69,
      title:
        "Quelque escolheu ne fonctionne pas correctement dans l'application. Quem é o contator ?",
      role: [ERoles.COOLING_USER],
      text: 'Certifique-se de que a última versão do aplicativo esteja instalada. Se o problema persistir, entre em contato com o explorador da câmara fria e/ou informe a equipe de assistência do aplicativo e envie um e-mail para app@yourvcca.org.',
    },
    {
      id: 70,
      title: 'Eu quero que você conheça minha experiência com o aplicativo. Quem é o contator ?',
      role: [ERoles.COOLING_USER],
      text: ' A equipe de assistência ao aplicativo tem como objetivo conhecer sua experiência de uso deste aplicativo e adicionar seus comentários. Envie um e-mail para app@yourvcca.org ou envie seus comentários por meio do formulário:https://forms.gle/ceohKHT2QCcE3rFs5 .',
    },
    {
      id: 71,
      title: 'Eu quero que você conheça minha experiência com o aplicativo. Quem é o contator ?',
    ...
    },
    {
      id: 74,
      title:
        'Eu estou em uma zona onde a conexão com a Internet está falhando: e quando você também usa o aplicativo?',
      role: [ERoles.COOLING_USER],
      text: 'Atualmente, somente a seção Centro de Conhecimento está disponível fora da linha. As informações do quadro de bordo e do local de mercado podem permanecer visíveis, mas podem ser imprecisas em caso de ausência de conexão. Nous vous recommandons de verificar nouveau quando a conexão for estável.',
    },
    {
      id: 75,
      title: 'Qual preço é exibido quando você clica no ícone «Prix des cultures» ?',
      role: [ERoles.EMPLOYEE],
      text: 'Nesta opção, você pode consultar as previsões de preço do mercado sob a forma de gráfico ou tabela. A página «Tendance des prix» permite visualizar os dados do último mês e as previsões de 14 dias para um mercado e uma estreia específica (na Índia) ou uma previsão mensal do Estado (na Nigéria). A página «Classificação de preço» permite visualizar todas as previsões de preços do mercado, classificados de mais alto ou mais baixo, com a possibilidade de filtro por data, estado, distrito e mercado (na Índia).',
    },
    {
      id: 76,
      title: 'Para certos estados e marchas mantidos na seção «Prix des récoltes» ?',
      role: [ERoles.OPERATOR],
      text: 'Devido à disponibilidade dos donativos, o modelo não foi o mesmo em obra para alguns produtos em determinados Estados seleccionados na Índia e na Nigéria. O prêmio do prêmio de culturas reporta apenas os mercados, os produtos e os estados para as mesmas e uma previsão está disponível.',
    },
    {
      id: 77,
      title: 'Como foram calculados os preços futuros do mercado?',
      role: [ERoles.COOLING_USER],
      text: 'Um modelo de aprendizagem automática é formado sobre os dados históricos do preço do mercado e outros dados informam que a taxa de conversão dos dispositivos e o preço da essência, para fazer as previsões dos preços futuros do mercado.',
    },
    {
      id: 78,
      title: 'Je souhaite supprimer mon compte. O que dois-je faire?',
      role: [ERoles.EMPLOYEE],
      text: 'Para apagar sua conta, acesse «Menu» -> «Detalhes da conta» e clique em «Suprimer». Atenção, esta ação é irreversível! Se você tiver o último funcionário inscrito na empresa, esta ação será reprimida. Se os registros forem observados, você não poderá suprimir sua conta, pois todos os caixas n"auront foram retirados do aplicativo por um de seus operadores.',
    },
    {
      id: 79,
      title: 'Je souhaite supprimer mon compte. O que dois-je faire?',
      role: [ERoles.EMPLOYEE],
      text: 'Para apagar sua conta, acesse «Menu» -> «Detalhes da conta» e clique em «Suprimer». Atenção, esta ação é irreversível! Se você tiver o último operador afetado em uma das salas onde os registros foram abertos, você não poderá suprimir sua conta, pois um funcionário registrado não afetou outro operador na sala ou que todas as caixas não foram aposentadas no aplicativo.',
    },
    {
      id: 80,
      title: 'Je souhaite supprimer mon compte. O que dois-je faire?',
      role: [ERoles.OPERATOR],
      text: 'Para apagar sua conta, acesse «Menu» -> «Detalhes da conta» e clique em «Suprimer». Atenção, esta ação é irreversível! Se você tiver matrículas no curso em uma das salas, você não poderá suprimir sua conta, tanto que todas as caixas em Auront foram aposentadas. Certifique-se de recuperar suas caixas diretamente na sala! Se você acha que está olhando para o aplicativo e está com problemas, entre em contato com o operador da sala para resolver o problema.',
    },
    {
      id: 81,
      title: 'Como você pode suprimir uma unidade de refroidissement ou uma colocação ?',
      role: [ERoles.EMPLOYEE],
      text: 'Você pode suprimir as unidades de climatização e os locais em « Menu » -> « Gestão » -> « Unidades de climatização » / « Locais » e clicar em « Suprimer ». Esta operação não será possível que não seja um plus de chegada nos quartos. Sinon, entre em contato com os operadores para finalizar a partida antes de apagar os quartos e as acomodações.',
    },
    {
      id: 82,
      title: 'Como posso suprimir um outro funcionário registrado ou um operador de minha empresa?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Você não está autorizado a suprimir outros usuários do aplicativo. No entanto, você pode retirar os operadores de suas saídas acessando « Menu » -> « Gerenciamento » -> « Operadores ». Se você deseja substituir definitivamente o usuário para que não tenha mais acesso à sua empresa, envie um e-mail para app@yourvcca.org e explique-o.',
    },
    {
      id: 83,
      title: 'Como você pode suprimir um usuário de refroidissement da lista ?',
      role: [ERoles.COOLING_USER],
      text: 'Para suprimir um usuário da lista, acesse «Gestion» -> «Utilisateurs de la climatisation», clique no seu nome e depois no botão «Supprimer». Observe que seus usuários sem registro podem ser excluídos! Se os registros não forem atendidos, entre em contato com o usuário para recuperar os produtos. Esta ação é irreversível! Se o usuário possuir um smartphone, esta operação suprimirá sua lista, mas você poderá usar o Coldtivate sempre. Se não for um smartphone, esta operação é suprimida e gratuita do número de telefone associado.',
    },
    {
      id: 84,
      title: 'Você pode verificar se os operadores usaram recentemente o aplicativo?',
      role: [ERoles.COOLING_USER],
      text: 'Para verificar a última conexão entre operadores e outros funcionários inscritos no aplicativo, acesse « Menu » -> « Gerenciamento » -> « Operador » / « Empregado inscrito ». A data e a hora indicadas no local do nome correspondem à última conexão.',
    },
    {
      id: 85,
      title:
        'Você pode monitorar a receita gerada por cada sala e outras estatísticas de utilização?',
      role: [ERoles.COOLING_USER],
      text: 'Aceda a « Menu » -> « Gestão » -> « Analisar receitas », selecione as unidades de refrigeração e o intervalo de tempo desejado. Você verá a receita total associada a essas vendas. Você também pode filtrar pelo usuário, modo de pagamento e hora. Para visualizar as estatísticas recapitulativas de suas entradas por salle (nome de usuários, número total de caixas, etc.), acesse « Menu » -> « Gerenciamento » -> « Análise de utilização ». Você também pode filtrar por data e por unidade de refrigeração. As informações são fornecidas no formato Excel nas duas páginas. A guia «Analisar» propõe um quadro de bordo contendo informações sobre os usuários, as receitas, a utilização e o impacto. Finalmente, para seguir o número total de caixas, seus pesos e as temperaturas ideais para as culturas atualmente presentes na sala, acesse « Plus » -> « Unidades de refrigeração » -> « Informações nas caixas ».',
    },
    {
      id: 86,
      title:
        'Como posso saber quem é a pessoa que entrará em contato para uma unidade de refrigeração dos produtos que estão em estoque?',
      role: [ERoles.OPERATOR],
      text: 'Ao clicar em um elemento da tabela de borda, você pode ver o nome e o número do telefone do operador que efetuou o registro. Você pode copiar esse número nos papéis de impressão e contatá-lo por telefone ou SMS.',
    },
    {
      id: 87,
      title: 'Eu recebi uma notificação. O que dois-je faire?',
      role: [ERoles.COOLING_USER],
      text: 'Você pode receber diferentes tipos de notificações: o aplicativo informa que certas caixas que você tem armazenados estão no ponto de saída. Nous vous vous conseillons de les recupérer au plus vite. Você também pode receber uma notificação sobre a conclusão do estudo de marcha após o estoque ou do estudo inicial. Clique na notificação para acessar perguntas. As informações coletadas são preciosas para a equipe Coldtivate, que avaliam as vantagens do uso de câmaras frias em relação ao armazenamento externo. Se você tiver caisses mises en vente no local de mercado, você também receberá notificações nos locais de venda e se o operador modificar o preço de venda. Se você não solicitar a modificação do preço, entre em contato imediatamente com o operador.',
    },
    {
      id: 88,
      title: 'Que montre la carte des unités de refroidissement ?',
      role: [ERoles.COOLING_USER],
      text: 'No cartão, você pode visualizar sua posição (autorização de acesso ao Coldtivate que você deseja), a localização de unidades de refroidissement autour de vous e certas informações preocupantes (produto único ou múltiplo, empresa, preço). Quando você está na sala fria, você pode obter informações complementares ao explorar o funcionamento da unidade e as possibilidades de armazenamento.',
    },
    {
      id: 89,
      title: ' Como posso mudar o idioma do aplicativo?',
      role: [ERoles.AUTH],
      text: ' Para alterar o idioma do aplicativo, você pode clicar no menu desejado para navegar na parte inferior da página inicial ou, uma vez conectado ao seu perfil, acesse « Menu » -> « Detalhes da conta » -> « Preferências de localização ».',
    },
    {
      id: 90,
      title:
        'Meu tipo de sensor de temperatura é compatível com Coldtivate (Ecozen, UbiBot, Figorr, Victron Energy). Como configurar os captores ?',
      role: [ERoles.EMPLOYEE],
      text: 'Para conectar um sensor a um climatizador, acesse «Menu» -> «Gestão» -> «Unidades de refrigeração», selecione a unidade para que o sensor esteja configurado e depois ative «Captor disponível». Siga as instruções para cada tipo de captura de preço carregada e autenticada. Não clique em “Registrar” na parte inferior da página para que as modificações soientem os preços em conta. Você deve verificar os níveis de temperatura dos seus captadores nas 6 horas seguintes, sob « Plus » -> « Unidades de refrigeração » -> « Condições ambientais ».',
    },
    {
      id: 91,
      title:
        ' Qual é a diferença entre os pontos «Entreprise», «Agrégée» e «Comparation» na análise?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'guia «Análises» da barra de navegação fornece estatísticas recapitulativas para todos os quartos livres da empresa. A visão «Entreprise» mostra os dados relativos aos usuários, à utilização e ao impacto de todas as unidades de refrigeração após sua primeira utilização do Coldtivate. Ao clicar em «Agrégé», você será convidado a configurar as unidades de refrigeração e o período que lhe interessa. Os dados publicados relativos aos utilizadores, a utilização e o impacto são aprovados para as unidades de refrigeração selecionadas no período escolhido. Para comparar as unidades, utilize a guia «Comparação». Os données são apresentados sob a forma de quadros, ou são apresentados os données de cada unidade de refroidissement no período escolhido. Você pode testar os dados e modificar as unidades de refrigeração e o período em todos os momentos.',
    },
    {
      id: 92,
      title: 'Como os dados exibidos na guia Analytics são calculados?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'onglet «Análises» tem como objetivo oferecer uma vista do conjunto da atividade dos quartos froides. Os dados de utilização e utilização são calculados a partir das entradas e saídas registradas no Coldtivate. Você também pode compreender o nome dos usuários e das operações realizadas, assim como o chefe de negócios ou as taxas de ocupação mais frias de cada quarto. Os dados da seção «Impacto», quanto a eles, são baseados nas perguntas que os usuários da câmara fria são convidados a preencher sua inscrição (c"est-à-dire antes de começar a utilizar a câmara fria) e regularmente durante a saída dos produtos da câmara fria. Esses données são essenciais para estimar a evolução das perdas pós-recolhimento e a receita dos usuários relacionadas à utilização da câmara fria. Finalmente, a estimativa de CO₂ compara as emissões contidas no resfriamento dos registros armazenados na câmara fria com as emissões anteriores que o mesmo registro foi gerado se ele estivesse armazenado sem refrigeração.',
    },
    {
      id: 93,
      title: 'Como os dados exibidos na guia Analytics são calculados?',
      role: [ERoles.COOLING_USER],
      text: 'guia «Análises» tem como objetivo oferecer uma visão do conjunto do impacto do refroidissement sobre suas culturas. Os dados exibidos em « Caisses » são calculados a partir das informações de entrada e das saídas registradas no Coldtivate. Você também pode saber a quantidade armazenada, o valor e a duração média do armazenamento. Os dados da seção «Impacto» são baseados nos questionários que você deve preencher para sua inscrição (c"est-à-dire antes de começar a utilizar a câmara fria) e regulamente durante a saída dos produtos da câmara fria. Esses dados são essenciais para estimar a evolução das perdas e a receita pós-recolhida baseada na utilização do resfriamento. Um convite para responder a esses questionários está afixado no topo da página, e nós encorajamos você a responder o máximo que for possível. Nas duas seções, você pode usar o botão «Configurar» à direita para selecionar quartos frios específicos ou um período. Se você não for selecionado, verifique todos os dados disponíveis depois de começar a usar o Coldtivate.',
    },
    {
      id: 94,
      title: 'Estou conectado, mas não sei a funcionalidade do Marketplace. Porquê?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Se o local de mercado for cobrado em seu país, você verá um ícone «Local de mercado» na barra inferior de navegação. Se você não viajar, isso significa que esta funcionalidade não é um prêmio cobrado em seu país. Por enquanto, o local de mercado é reservado para usuários com base na Nigéria. Se você tiver um funcionário inscrito e quiser testar o local de mercado em seu país, entre em contato com o endereço app@yourvcca.org.',
    },
    {
      id: 95,
      title: ' Qual é o papel de uma empresa de refrigeração no mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Uma empresa de refrigeração e seus funcionários podem decidir seu nível de implicação no local de mercado. Como esta funcionalidade repousa sobre o registro de caixas no aplicativo Coldtivate, um local de mercado não pode funcionar, pois se o explorador da câmara fria registrar regularmente as entradas e as saídas no aplicativo. Para os produtos adquiridos através do local de mercado, a empresa de refrigeração coloca os preços de refrigeração no quadro da transação numérica. É crucial que um funcionário escreva as coordenadas bancárias da empresa definindo: para isso, acesse « Menu » -> « Gestão » -> « Parâmetros do vendedor (empresa) » -> « Opções de pagamento ». Além disso, as empresas de refrigeração podem decidir comprar produtos para agricultores (en tant qu"acheteur) e les revendre sur la place de marché (en tant que vendeur). As duas transações podem ser efetuadas através do local de mercado Coldtivate. Observe que os operadores e os funcionários estão inscritos na escolha de compras para eux-mêmes (no título individual) ou para a conta da empresa que os representa.',
    },
    {
      id: 96,
      title: 'Qual é o papel de um operador de quarto frio no mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Les opérateurs de chambres froides sur la place de marché ont trois rôles principaux. 1) Ajuda os usuários de quartos livres sem smartphone a criar sua conta bancária (para poder receber pagamentos numéricos), listando suas caixas “à venda” e seu preço. 2) Eles são responsáveis pela organização de produtos na câmara fria, de acordo com o príncipe, de acordo com todos os produtos contidos em uma caixa fornecida por um usuário: quando uma festa de produtos de uma caixa é adquirida (e enviada por outro proprietário), o operador Receba uma notificação e exija a transferência dos produtos adquiridos em uma caixa separada. Se uma caixa inteira estiver comprada, nenhuma ação será necessária. 3) Os operadores de quartos froides são responsáveis por todas as operações de pagamento, e compreendem células resultantes do local de mercado: quando um acheteur (ou um livreur) chega à sala froide para recuperar os produtos adquiridos, o operador deve encaisser esta caixa auprès de Coldtivate.',
    },
    {
      id: 97,
      title: 'Como os preços de refroidissement são coletados no mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Ao comprar caisses no local de mercado, os preços de refroidissement en vigueur jusqu"à ce jour são deduzidos do preço pago pelo comprador e transferidos para a empresa de refrigeração. Então, o vendedor não tem regras para esse valor, mas eles são regulamentados durante a transação numérica. É essencial que o vendedor e a empresa de refrigeração disponham de uma conta bancária no Coldtivate. Por exemplo, se uma caixa for adquirida por 20 USD e o vendedor pagar 3 USD de frete de refroidissement, os 20 USD pagos pelo comprador, 17 USD serão transferidos para sua conta bancária e 3 USD para o celular da empresa de refrigeração. Se o comprador viet recuperar os produtos do dia em que o comprou, mas outros itens de refroidissement não são dû (car les frais journaliers são déjà réglés par le vendeur). Em seguida, se o acionista decidir conservar os produtos na câmara fria, os valores padrão de refroidissement serão aplicados e o preço será calculado em função do número de dias de conservação dos produtos na câmara fria, junto com seu retorno pelo acionista. O explorador da câmara fria é responsável pela percepção do frescor da refrigeração durante a passagem na caixa. Observe que a mesma lógica é aplicada em caso de entrega.',
    },
    {
      id: 98,
      title: 'Como posso começar a vender produtos no mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para que suas caixas estejam disponíveis à venda, você deve realizar duas ações. 1) Crie uma conta bancária no valor da receita depositada. Se você tiver um smartphone, acesse « Menu » -> « Detalhes da conta » -> « Opções de pagamento ». Se você não tiver um smartphone, o operador poderá configurar as contas bancárias a partir da interface («Gestion» -> «Utilisateurs en cours de refroidissement» -> «Detalhes de pagamento». Observe que todos os pagamentos são efetuados numéricamente no local de mercado, você deve fornecer uma conta bancária válida 2) Se você tiver um smartphone, para cada lote de caixas registradas, clique no sinal « > » à direita de cada elemento da tabela de borda, acesse «Poids des caisses et liste de la place de marché», defina as caixas para mettre en vente et le prix au kg. Os consumidores do local de mercado podem consultar essas caixas e comprá-las no local indicado. Você receberá uma notificação de uma compra que será finalizada. Se você não tiver um smartphone, o operador da sala fria derramará caisses em frente ao registrar seu registro, ou depois, seguindo os mesmos passos. Você receberá um SMS se o operador receber suas caixas ou seu preço após o registro.',
    },
    {
      id: 99,
      title: 'Os comerciantes podem ter as mesmas coordenadas?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: ' Você pode decidir o mesmo se os clientes interessados em seus produtos não tiverem acesso às suas coordenadas. Cela pode ser útil em casos de negociação de preços ou de comandos recorrentes de produtos não ainda estocados em quarto frio (e invisíveis para o acionista). Você pode modificar suas configurações em todos os momentos em « Menu » -> « Detalhes da conta » -> « Partage des contact ».',
    },
    {
      id: 100,
      title: ' Eu quero oferecer uma remessa a um comprador. Comentário justo?',
      role: [ERoles.EMPLOYEE],
      text: 'Em « Menu » -> « Detalhes da conta » -> « Cupons de redução », você pode criar cupons com um código e uma porcentagem de redução. Esses cupons são válidos para os produtos que você vende (individualmente). Para definir cupons válidos para produtos pertencentes à empresa, acesse « Menu » -> « Gerenciamento » -> « Cupons de redução » sob « Parâmetros do vendedor (Entreprise) ». Você pode compartilhar o código com o cliente, que pode utilizá-lo na tela de pagamento. Os códigos restantes válidos apenas serão revogados. Se você quiser oferecer uma redução a todos os compradores potenciais, você poderá baixar o preço de venda afixado no local de mercado.',
    },
    {
      id: 101,
      title: ' Eu quero oferecer uma remessa a um comprador. Comentário justo?',
      role: [ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Em « Menu » -> « Detalhes da conta » -> « Cupons de redução », você pode criar cupons com um código e uma porcentagem de redução. Você pode compartilhar o código com o cliente, para usá-lo na tela de pagamento. Os códigos restantes válidos apenas serão revogados. Se você quiser oferecer uma redução a todos os compradores potenciais, você poderá baixar o preço de venda afixado no local de mercado.',
    },
    {
      id: 102,
      title:
        ' Como os exploradores de quartos froides podem ajudá-los a comercializar seus comentários?',
      role: [ERoles.COOLING_USER],
      text: 'Os operadores de quartos froides são seu interlocutor para tudo o que diz respeito ao armazenamento de produtos em quartos froides e podem também ajudá-lo a comercializar seus registros, mesmo sem smartphone. A partir de sua interface, ele pode configurar suas coordenadas bancárias para que você perceba a receita da venda de seus produtos. Durante o seu registro, você poderá ajudá-lo a manter suas caixas de venda, para que fiquem visíveis no local de mercado e para fixar o preço de venda (au kg) de cada produto. Se você mudar de aviso, você poderá sempre exigir ajuntar ou suprimir as caixas da praça de mercado no ajoutant ou no supprimant. Em certas casas frias, os operadores ou seus colaboradores são igualmente encarregados de comprar os produtos diretamente aos agricultores e aos vendedores de detalhes. Se você é um agricultor, comerciante ou detalhado interessado nesta opção, entre em contato com a empresa de refrigeração para explorar esta oportunidade.',
    },
    {
      id: 103,
      title:
        'Qual é a opção “Comprar o nome da empresa” que você está visitando no local de mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR],
      text: 'Os operadores e os empregados inscritos podem vender e comprar produtos no local de mercado, que são para eux-mêmes, em título individual ou em nome da empresa que os representa. Esta opção permite efetuar todas as transações desde e contra a conta bancária da empresa, e não por meio de contas bancárias individuais. Quando um operador ou um empregado inscreveu os produtos «para a conta de uma empresa», eles são o montante do vendedor e o proprietário desviante das caixas. Se essas caixas são mises en vente sur la place de marché, elas são présentées como parte da empresa de refrigeração, e os frais de vente são versados na conta bancária da empresa. Quando um operador ou um funcionário registrado compra produtos para si mesmo, o dinheiro que você vende é vendido por suas coordenadas bancárias e pelo proprietário de caixas. Se as caixas forem armazenadas na unidade de refrigeração, elas serão reportadas ao nome do operador ou do funcionário inscrito; se eles forem mises en vente na praça do mercado, eles serão igualmente presentes como presentes ao operador ou ao funcionário inscrito.',
    },
    {
      id: 104,
      title: 'que são os frais afixados na praça de mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: ' O preço de venda de cada artigo afixado no local de mercado é fixo diretamente pelo vendedor e depende do número de quilos adquiridos. Àquele montant s"ajoutent deux frais: os frais do local de mercado, que correspondem a uma comissão de transação de 3,5%, prélevados pela equipe Coldtivate para o alojamento e manutenção do aplicativo. Os frais de pagamento, quanto eux, são faturados pelo sistema de pagamento numérico (PayStack na Nigéria) para caracterizar a transação.',
    },
    {
      id: 105,
      title:
        'Eu quero comprar produtos frescos no quarto frio, mas não encontro dinheiro no mercado. Porquê?',
      role: [ERoles.COOLING_USER],
      text: 'Se você acessar o local de mercado mais que você não encontre nenhum produto, pode haver filtros que você tenha aplicados à pesquisa (como a localização, a compra de preço ou a cultura desejada), ou au fait qu"aucun artigo não está disponível à venda nas proximidades. Se você conhece uma sala fria nas proximidades, vamos fazer recomendações para quem procura explorar, se um usuário da sala fria deseja vender produtos através do local de mercado e exigir que esses artigos sejam reportados no aplicativo.',
    },
    {
      id: 106,
      title: 'Oferecer serviços de entrega?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'local de mercado não oferece mais serviços de entrega, mas facilita o relacionamento com soluções logísticas capazes de liberar produtos para compradores. Enquanto você está inscrito, você tem a possibilidade de adicionar contatos de entrega em « Menu » -> « Gerenciamento » -> « Parâmetros do vendedor (empresa) » -> « Contatos de entrega ». Estas informações são visíveis para todos os compradores de produtos em seus quartos froides durante o pagamento. Se você for um comprador, nós encorajamos você a entrar em contato com o organizador da sua entrega. Tenha em atenção que se os produtos forem retirados no mesmo dia da compra, mesmo que não sejam solicitados. Em seguida, se você estocar as informações, o valor diário é o mesmo. Certifique-se de discutir com o contato de entrega com o quanto você negocia.',
    },
    {
      id: 107,
      title:
        'Eu recebi uma notificação no aplicativo indicando que “Os produtos devem ser redistribuídos”. O que é isso?',
      role: [ERoles.OPERATOR],
      text: 'Devido ao procedimento de registro em câmara fria, o conteúdo de uma caixa pertence a um agricultor ou comerciante. Como na praça de mercado, um comprador pode comprar alguns quilos de uma caixa que aparece em um vendedor, a quantidade comprada pode ser transferida para uma caixa separada. Esta notificação irá informá-lo sobre uma compra finalizada e, em seguida, você poderá visualizá-la na caixa onde os produtos devem ser pré-levados. A organização das caixas é essencial para evitar erros de registro e para que os erros de refroidissement sejam corrigidos. Nós recomendamos usar a funcionalidade «ID de caixa» durante o registro para etiquetar as caixas no Coldtivate com caixas físicas e também um identificador, além de facilitar as caixas que precisam de atenção à notificação.',
    },
    {
      id: 108,
      title: ' Qual a quantidade de produtos que você pode comprar no mercado?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Para cada artigo apresentado no local de mercado, você pode comprar a caixa inteira ou o número de quilos que ela contém. A quantidade mínima autorizada é de 1 kg.',
    },
    {
      id: 109,
      title: 'Eu comprei os produtos e quero que eles sejam vendidos. Comentário justo?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Quando você compra produtos no local de mercado, você deve ser proprietário da quantidade comprada. No quadro de borda, uma nova entrada indica o que você tem estocado no quarto frio. Para vender seus produtos, clique no sinal « > » à direita da tabela de borda, acesse « Poids des caisses et liste de la place de marché », depois indique as caixas de venda e o preço por kg. Os consumidores do local de mercado podem consultar essas caixas e comprar a montanha indicada. Observe que, para manter as caixas em vendas, sua conta bancária deve estar configurada. Siga as instruções para adicionar suas coordenadas bancárias ou acesse « Menu » -> « Detalhes da conta » -> « Opções de pagamento ».',
    },
    {
      id: 110,
      title:
        ' Eu desisti do processo de pagamento no local de mercado. Finalizador de comentários mon achat ?',
      role: [ERoles.EMPLOYEE, ERoles.OPERATOR, ERoles.COOLING_USER],
      text: 'Ao efetuar uma compra no cliente em «Pagador» em seu pagamento, você será redirecionado para o fornecedor de pagamento (PayStack na Nigéria). Se, por uma razão quelconque, você abandone o processo, seu comando será marcado como «Pagamento em atenção». Você encontrará seu comando na guia «Meus comandos» da página do Marketplace. Clique no artigo para finalizar o pagamento. Você dispõe de 30 minutos para finalizar o pagamento, após o que o comando é considerado como «Anulado» e o monte é liberado para outros compradores.',
    },
    {
      id: 111,
      title: ' Eu não chego à extração de certas culturas. Porquê?',
      role: [ERoles.OPERATOR],
      text: 'Se você tentar o comando das caisses em vendas no local de mercado e não quiser passar, é provável que você faça o que eles fazem parte de um comando na atenção do pagamento. Isso significa que você comprou um pacote de compras e lançou um processo de compra. O agente dispõe de 30 minutos para finalizar o pagamento, após o comando ser anulado. Passé ce délai, vous pourrez comandante da caixa.',
    },
  ],
  [APP_LOCALES.FRENCH]: [
    {
