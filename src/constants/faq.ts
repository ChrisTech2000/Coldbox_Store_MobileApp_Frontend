...
export const FAQ_CONTENT = [
  ...
  },
  {
    ...
    role: ['Service Provider'],
    image: '',
    text: "To invite other Registered employees for your company, in the menu select 'Management' > 'Service Provider'. Click on the '+' on the top right corner to add the telephone number of the employee you want to invite. Click 'Invite' to confirm: your colleague will receive an SMS with a link that guides him/her directly to the sign up screen. In addition, you will also receive an email with the invitation link. Please forward this to the operator in case he/she did not receive it via SMS.",
  },
  {
    id: 22,
  ...
  },
  {
    ...
    role: ['Service Provider', 'Operator'],
    image: '',
  ...
  },
  {
    ...
    role: ['Service Provider', 'Operator', 'Farmer'],
    image: '',
  ...
  },
  {
    ...
    role: ['Service Provider'],
    image: '',
    text: "To check the last time the operators and other registered employees have logged in into the app, you can navigate to 'Menu' -> 'Management' -> 'Operator' / 'Service Provider'. The date and time you see next to the name are the last login date and time.",
  },
  {
    id: 82,
