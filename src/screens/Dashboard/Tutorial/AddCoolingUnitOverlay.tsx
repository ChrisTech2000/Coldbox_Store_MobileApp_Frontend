...
export function AddCoolingUnitOverlay({ next, goTo, stop }: IOverlayComponentProps) {
  ...
  return (
    <View tw="h-full w-full absolute">
      ...
      >
        <Text tw="text-base">{t('tutorial.steps.addCoolingUnits')}</Text>
        ...
        <View tw="flex flex-row flex-wrap justify-center items-center mt-2">
          <Button
            ...
            onPress={() => {
              ...
              goTo(EEmployeeTutorialSteps.COOLING_UNITS_STEP);
            }}
